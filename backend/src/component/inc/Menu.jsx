...
export default function Menu(){
    ...
    const togglePagesMenu = (e,name) => {
      e.preventDefault();
      if(name == 'category'){
        setToggleMenu({
          ...toggleMenu,
          category: !toggleMenu.category
        })
      }else{
        ...
        <div className="py-4 text-gray-500 dark:text-gray-400">
          ...
          <li className="relative px-6 py-3">
              <button
                ...
                onClick={(e) => togglePagesMenu(e,'category')}
                aria-haspopup="true"
              >
              ...
              >
                <Link className="w-full" to="/admin/categories">Category</Link>
              </li>
                <li
                  className="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                >
                  <Link className="w-full" to="/admin/sub-categories">Sub Category</Link>
                </li>
                <li
                  className="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                >
                  <Link className="w-full" to="/admin/sub-sub-categories">Sub Sub Category</Link>
                </li>
              </ul> 
              ) }
            </li>
            ...
            <li className="relative px-6 py-3">
              ...
              >
                ...
                <span className="ml-4">Attributes</span>
              </Link>
            </li>
            <li className="relative px-6 py-3">
              <a
