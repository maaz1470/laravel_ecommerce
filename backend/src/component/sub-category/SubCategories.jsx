...
export default function SubCategories(){
  ...
  const deleteSubCategory = (e,id) => {
    e.preventDefault();
    axios.get(`/api/sub-categories/delete/${id}`).then(response => {
    ...
    return (
        <>
            <div className="flex justify-between items-center">
                ...
                <Link to="/admin/add-sub-category" className="bg-green-400 text-white px-3 py-2 h-max rounded text-md">Add Sub Category</Link>
            </div>
                            ...
                            <div className="flex justify-between w-1/3">
                              {
                                ...
                                <Link to={`/admin/sub-categories/edit/${el.id}`} className="bg-blue-600 px-3 py-2 rounded text-white"><i className="fa fa-pencil" aria-hidden="true"></i></Link>
                                <a onClick={(e) => deleteSubCategory(e,el.id)} href="" className="bg-red-500 px-3 py-2 rounded text-white"><i className="fa fa-trash" aria-hidden="true"></i></a>
                            </div>
                          </td>
                        </tr>
                      ))
